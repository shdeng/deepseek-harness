...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  desktopNative: 'desktop-native.md',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  DesktopGameCompanion: 'desktop-native.md',
  DesktopMediaCompanion: 'desktop-native.md',
  DesktopNotification: 'desktop-native.md',
  GameAsset: 'game.md',
  GameAssetId: 'game.md',
  GameDescriptor: 'game.md',
  GameId: 'game.md',
  GameRegistration: 'game.md',
  GameRegistryChange: 'game.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  ClientModuleAsset: 'transport-neutral client asset bytes are owned by packages/client/modules/README.md',
