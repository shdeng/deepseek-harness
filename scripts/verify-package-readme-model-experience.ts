...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/host/directory-picker-desktop': { kind: 'none', reason: 'The Desktop picker backend registers nothing model-facing.' },
  'packages/host/desktop-native': { kind: 'indirect', reason: 'Host consumers own any product operation that uses a native result.' },
  ...
  'packages/host/game': { kind: 'none', reason: 'Human-played Desktop game registry; registers nothing model-facing.' },
  'packages/host/game-2048': { kind: 'none', reason: 'Human-played isolated game Provider; registers nothing model-facing.' },
  'packages/host/game-companion': { kind: 'none', reason: 'Host-only game presentation Consumer; registers nothing model-facing.' },
  ...
  'packages/bundle/desktop-app': { kind: 'none', reason: 'The Desktop patch carrier selects a native GUI provider and registers no model-facing content.' },
  ...
  'packages/credentials/credentials-system': { kind: 'indirect', reason: 'The system-vault provider stores credential values; consumers of ctx.credentials own any model-facing behavior.' },
