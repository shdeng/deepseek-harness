// Hero chrome for the blank-draft phase of ConversationRoot: app-mark headline,
    ...
    <div className={css.root}>
      <div className={css.stack}>
        <div className={css.headline}>
          {/* The shared app mark leads the headline. */}
          <span className={css.appLogoHitbox}>
            <AppLogo size={34} className={css.appLogo} />
          </span>
