...
export const en = {
  ...
  loadingCredential: 'Checking credential storage…',
  keyCaptureNative: 'Enter securely in the system dialog',
  keyCaptureOnCreate: 'A secure system prompt will open after the provider is created.',
  keyReplaceNative: 'Replace securely in the system dialog',
  keyCapturing: 'Waiting for the system dialog…',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  loadingCredential: '正在检查凭据存储…',
  keyCaptureNative: '在系统对话框中安全输入',
  keyCaptureOnCreate: '创建提供商后将打开安全的系统输入对话框。',
  keyReplaceNative: '在系统对话框中安全替换',
  keyCapturing: '正在等待系统对话框…',
  customized: '自定义设置',
  baseUrl: 'API 地址',
